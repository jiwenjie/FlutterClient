...
class CommonBanner extends StatefulWidget {
  ...
  CommonBanner(this.bannerStories, this.onTap, {Key key})
        : super(key: key);
...
class _BannerState extends State<CommonBanner> {
  ...
  void initState() {
    ...
    timer = Timer.periodic(Duration(seconds: 5), (timer) {      // 设置定时器自动滚动
      /// print(realIndex);
